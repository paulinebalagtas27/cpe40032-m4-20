...
function StartState:render()
    ...
    love.graphics.setColor(50, 50, 4, 128)
...
function StartState:drawMatch3Text(y)
    ...
    self:drawTextShadow('CRUSH 3', VIRTUAL_HEIGHT / 2 + y)
...
function StartState:drawOptions(y)
    ...
    love.graphics.setColor(229,204,255, 128)
    ...
    if self.currentMenuItem == 1 then
        ...
        love.graphics.setColor(229, 204,224, 255)
    end
